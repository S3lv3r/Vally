...
{
    public partial class FrmSumas : Form
    {
        private MathOperation.SumOperation sumoperation;
        ...
        public FrmSumas()
        {
            ...
            LblBestScore.Text = "Mejor Puntuacion: " + Convert.ToString(scoreControl.ReadScore(0));
            ...
            sumoperation = new MathOperation.SumOperation();
            sumoperation.SetControls(this.Controls);
            sumoperation.AssingNumbers();
            sumoperation.GiveThePropertiesToTxtBox();
            sumoperation.PutTheActionOfTheSubIndice();
        ...
        private void BtnCheck_Click(object sender, EventArgs e)
        {
            ...
            if (IsComplete)
            {
                ...
                if (time <= 60)
                {
                    PointsTimes = 500 - (sumoperation.NumbersOfIncorrects * 50);
                }
                else
                {
                ...
                double Puntation = (50 * sumoperation.NumbersOfCorrects) + PointsTimes;
                LblPNLPuntuacion.Text = "Tu puntuacion fue de " + Convert.ToString(Puntation);
                //----
                if(Puntation > scoreControl.ReadScore(0))
                {
                    ...
                    if (lines.Length > 0)
                    {
                        lines[0] = Convert.ToString(Puntation);
                    }
                ...
                if (sumoperation.NumbersOfCorrects >= 7)
                {
